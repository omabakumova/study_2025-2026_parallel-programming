...
contains
  ...
  function monty(alternate)
    ...
    logical(kind=1) :: doors(1:doors_quantity) ! массив из 3 логических значений, указывает, за какой дверью приз
    ! Выбор игрока
    logical(kind=1) :: pick(1:doors_quantity) ! массив из 3 логических значений, указывает выбор игрока
